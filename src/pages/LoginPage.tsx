        ...
        <div className="bg-card rounded-xl border p-6 space-y-4">
          {isSignup && (
            <div>
              ...
              <input className="w-full h-9 border rounded-md px-3 text-sm bg-background" placeholder="Your name" />
            </div>
          )}
          <div>
            ...
            <div className="relative">
              ...
              <input className="w-full h-9 border rounded-md pl-9 pr-3 text-sm bg-background" placeholder="email@example.com" />
            </div>
          </div>
          <div>
            ...
            <div className="relative">
              ...
              <input type="password" className="w-full h-9 border rounded-md pl-9 pr-3 text-sm bg-background" placeholder="••••••••" />
            </div>
          </div>
          <Button className="w-full bg-accent text-accent-foreground hover:bg-accent/90" onClick={() => navigate('/')}>
